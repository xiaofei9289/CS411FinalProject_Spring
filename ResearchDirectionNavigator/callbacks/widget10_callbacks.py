...
# define a register function to register all widget 10 callbacks to the Dash app
def register(app):
    @app.callback(
    ...
    # define a function to update Widget10 academic results UI based on search or button trigger
